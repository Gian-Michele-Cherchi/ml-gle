...
```
This launches jobs which are run sequentially, but multiprocessing can be exploited with joblib lanucher [JobLib Launcher](https://hydra.cc/docs/plugins/joblib_launcher/)
